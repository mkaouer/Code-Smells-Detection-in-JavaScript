...
#line 50 "tgbaparse.cc"
/* Unqualified %code blocks.  */

/* Line 300 of lalr1.cc  */
#line 56 "tgbaparse.yy"
...
#line 80 "tgbaparse.yy"
	{ delete (yyvaluep->str); };

/* Line 480 of lalr1.cc  */
#line 323 "tgbaparse.cc"
	break;
      case 4: /* "UNTERMINATED_STRING" */
...
#line 81 "tgbaparse.yy"
	{
  for (std::list<const spot::ltl::formula*>::iterator i = (yyvaluep->list)->begin();
	 ...
	 if ((yysemantic_stack_[(8) - (5)].str))
	   {
		 ...
		 const formula* f =
		   spot::ltl::parse_boolean(*(yysemantic_stack_[(8) - (5)].str), pel, parse_environment,
					    debug_level());
		 for (parse_error_list::iterator i = pel.begin();
		      i != pel.end(); ++i)
		   {
		     // Adjust the diagnostic to the current position.
		     location here = (yylocation_stack_[(8) - (5)]);
...
#line 173 "tgbaparse.yy"
    {
	 (yyval.list) = new std::list<const formula*>;
       }
    break;
...
#line 177 "tgbaparse.yy"
    {
	 if (*(yysemantic_stack_[(2) - (2)].str) == "true")
	   ...
	   {
	     const formula* f = parse_envacc.require(*(yysemantic_stack_[(2) - (2)].str));
...
#undef YYCASE_
  ...
  parser::yyrline_[] =
  {
         0,    91,    91,    92,    94,    96,    98,   101,   102,   105,
