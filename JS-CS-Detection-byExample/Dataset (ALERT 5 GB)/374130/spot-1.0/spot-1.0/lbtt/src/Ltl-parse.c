...
/* Line 1806 of yacc.c  */
#line 142 "Ltl-parse.y"
    { result = (yyvsp[(1) - (1)].formula); }
    break;

  case 3:

/* Line 1806 of yacc.c  */
#line 146 "Ltl-parse.y"
...
/* Line 1806 of yacc.c  */
#line 162 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(1) - (3)].formula));
                         (yyval.formula) = newFormula(Not::construct((yyvsp[(1) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 168 "Ltl-parse.y"
    { (yyval.formula) = (yyvsp[(1) - (3)].formula); }
    break;

  case 10:

/* Line 1806 of yacc.c  */
#line 171 "Ltl-parse.y"
...
/* Line 1806 of yacc.c  */
#line 178 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(2) - (2)].formula));
                         (yyval.formula) = newFormula(Not::construct((yyvsp[(2) - (2)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 184 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(2) - (2)].formula));
                         (yyval.formula) = newFormula(Next::construct((yyvsp[(2) - (2)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 190 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(2) - (2)].formula));
                         (yyval.formula) = newFormula(Finally::construct((yyvsp[(2) - (2)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 196 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(2) - (2)].formula));
                         (yyval.formula) = newFormula(Globally::construct((yyvsp[(2) - (2)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 222 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(2) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(And::construct((yyvsp[(2) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 229 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(2) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(Or::construct((yyvsp[(2) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 236 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(2) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(Imply::construct((yyvsp[(2) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 243 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(2) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(Equiv::construct((yyvsp[(2) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 250 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(2) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(Xor::construct((yyvsp[(2) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 257 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(2) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(Until::construct((yyvsp[(2) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 264 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(2) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(V::construct((yyvsp[(2) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 271 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(2) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(WeakUntil::construct((yyvsp[(2) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 279 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(2) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(StrongRelease::construct((yyvsp[(2) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 286 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(2) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(Before::construct((yyvsp[(2) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 294 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(1) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(And::construct((yyvsp[(1) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 301 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(1) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(Or::construct((yyvsp[(1) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 308 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(1) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(Imply::construct((yyvsp[(1) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 315 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(1) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(Equiv::construct((yyvsp[(1) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 322 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(1) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(Xor::construct((yyvsp[(1) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 329 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(1) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(Until::construct((yyvsp[(1) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 336 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(1) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(V::construct((yyvsp[(1) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 343 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(1) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(WeakUntil::construct((yyvsp[(1) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 350 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(1) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(StrongRelease::construct((yyvsp[(1) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
...
/* Line 1806 of yacc.c  */
#line 357 "Ltl-parse.y"
    {
                         intermediate_results.erase((yyvsp[(1) - (3)].formula));
			 intermediate_results.erase((yyvsp[(3) - (3)].formula));
                         (yyval.formula) = newFormula(Before::construct((yyvsp[(1) - (3)].formula), (yyvsp[(3) - (3)].formula)));
                       }
    break;
