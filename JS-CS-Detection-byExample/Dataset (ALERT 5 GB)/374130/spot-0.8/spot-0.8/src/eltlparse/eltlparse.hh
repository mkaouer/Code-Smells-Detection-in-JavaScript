...
#line 170 "eltlparse.hh"
   ...
   enum yytokentype {
    ...
    parser (spot::eltl::nfamap& nmap_yyarg, spot::eltl::aliasmap& amap_yyarg, spot::eltl::parse_error_list_t &pe_yyarg, spot::ltl::environment &parse_environment_yyarg, spot::ltl::formula* &result_yyarg);
    virtual ~parser ();
