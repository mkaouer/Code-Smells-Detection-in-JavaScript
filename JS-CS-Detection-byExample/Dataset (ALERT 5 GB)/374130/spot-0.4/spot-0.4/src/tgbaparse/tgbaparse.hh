...
#line 124 "tgbaparse.hh"
   ...
   enum yytokentype {
    ...
    parser (spot::tgba_parse_error_list& error_list_yyarg, spot::ltl::environment& parse_environment_yyarg, spot::ltl::environment& parse_envacc_yyarg, spot::tgba_explicit*& result_yyarg, formula_cache& fcache_yyarg);
    virtual ~parser ();
