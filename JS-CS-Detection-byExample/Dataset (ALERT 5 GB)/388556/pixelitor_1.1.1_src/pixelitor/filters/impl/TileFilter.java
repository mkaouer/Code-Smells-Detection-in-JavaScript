...
public class TileFilter extends TransformFilter {
    ...
    public void setSizeX(int size) {
        this.scaleX = (float) (Math.PI / size);
    }

    public void setSizeY(int size) {
        this.scaleY = (float) (Math.PI / size);
    }
    ...
    protected void transformInverse(int x, int y, float[] out) {
        ...
        float sampleX = (float) (i + (curvature * Math.tan(i * scaleX)));
        float sampleY = (float) (j + (curvature * Math.tan(j * scaleY)));
