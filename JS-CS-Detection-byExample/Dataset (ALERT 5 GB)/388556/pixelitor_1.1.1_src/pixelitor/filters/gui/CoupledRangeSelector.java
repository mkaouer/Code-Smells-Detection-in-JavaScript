...
public class CoupledRangeSelector extends JPanel {
    public CoupledRangeSelector(final CoupledRangeParam model) {
        ...
        coupledCB.setSelected(model.isCoupled());

        GridBagHelper.addLabelWithControl(this, firstRangeParam.getName(), 0, new SliderSpinner(firstRangeParam, true, SliderSpinner.TextPosition.NONE));
        GridBagHelper.addLabelWithControl(this, secondRangeParam.getName(), 1, new SliderSpinner(secondRangeParam, true, SliderSpinner.TextPosition.NONE));
