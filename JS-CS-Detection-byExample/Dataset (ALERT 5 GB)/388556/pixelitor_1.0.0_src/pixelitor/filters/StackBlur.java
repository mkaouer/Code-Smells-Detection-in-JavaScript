 ...
 * Stack Blur
 */
public class StackBlur extends FilterWithSOParametrizedGUI {
    ...
    public StackBlur() {
        ...
        paramSet = new ParamSet(radiusParam, hpSharpening, showOriginalParam);
    }
    ...
    public BufferedImage realTransform(BufferedImage src, BufferedImage dest) {
        ...
        StackBlurFilter filter = new StackBlurFilter(radiusParam.getValue());
