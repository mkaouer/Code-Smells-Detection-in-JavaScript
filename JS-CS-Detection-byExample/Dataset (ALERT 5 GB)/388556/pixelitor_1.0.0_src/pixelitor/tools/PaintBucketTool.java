...
public class PaintBucketTool extends Tool {
    ...
    public PaintBucketTool() {
        super('p', "Paint Bucket", "paint_bucket_tool_icon.gif", "click to fill with the selected color", Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR), true, true, false);
    }
