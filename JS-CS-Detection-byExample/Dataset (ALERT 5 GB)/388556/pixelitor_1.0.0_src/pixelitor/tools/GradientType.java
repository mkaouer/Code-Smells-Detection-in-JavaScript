...
public enum GradientType {
    LINEAR {
        ...
        public Paint getGradient(UserDrag userDrag, Color[] colors, MultipleGradientPaint.CycleMethod cycleMethod) {
            ...
            return new LinearGradientPaint(start, end, FRACTIONS, colors, cycleMethod, colorSpaceType, gradientTransform);
        }
    }, RADIAL {
        @Override
        public String toString() {
        ...
        public Paint getGradient(UserDrag userDrag, Color[] colors, MultipleGradientPaint.CycleMethod cycleMethod) {
            ...
            return new RadialGradientPaint(center, radius, center, FRACTIONS, colors, cycleMethod, colorSpaceType, gradientTransform);
        }
    }, ANGLE {
        @Override
        public String toString() {
