...
public class Composition implements Serializable {
     ...
     */
    public void changeActiveLayerImage(BufferedImage img, ChangeReason changeReason, String opName) {
        ((ImageLayer) activeLayer).changeImage(img, changeReason, opName);
...
//        BufferedImage imageSoFar = ImageUtils.createCompatibleImage(getCanvasWidth(), getCanvasHeight());
        ...
        BufferedImage imageSoFar = new BufferedImage(canvasWidth, canvasHeight, BufferedImage.TYPE_INT_ARGB_PRE);
