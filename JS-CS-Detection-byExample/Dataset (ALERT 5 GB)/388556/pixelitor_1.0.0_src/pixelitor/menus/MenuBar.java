...
import pixelitor.filters.ArbitraryRotate;
...
public class MenuBar extends JMenuBar {
    ...
    private void initEditMenu() {
        ...
        MenuFactory.createMenuItem(new ArbitraryRotate(), null, editMenu, MenuEnableCondition.IF_THERE_IS_OPEN_IMAGE);
...
//        MenuFactory.createMenuItem(new StaticLookupOp(StaticLookupType.REMOVE_BLUE), null, channelsSubmenu);
    ...
    private static void initBlurSharpenSubmenu(JMenu filterMenu) {
        ...
        MenuFactory.createMenuItem(new StackBlur(), null, bsSubmenu);
...
//                Composite composite =  new TestComposite();
    ...
    private static void initTestSubmenu(JMenu developMenu) {
        ...
        MenuFactory.createMenuItem(new ParamTest(), null, testSubmenu);
