...
public class JHWood extends FilterWithParametrizedGUI {
    ...
    private RangeParam fibresParam = new RangeParam("Fibres", 0, 100, 0);
    private RangeParam gainParam = new RangeParam("Gain", 0, 100, 80);

    private float[] defaultThumbPositions = new float[]{0f, 1f};
    private Color[] defaultValues = new Color[]{new Color(229, 196, 148), new Color(152, 123, 81)};
    private GradientParam gradientParam = new GradientParam("Colors", defaultThumbPositions, defaultValues);
