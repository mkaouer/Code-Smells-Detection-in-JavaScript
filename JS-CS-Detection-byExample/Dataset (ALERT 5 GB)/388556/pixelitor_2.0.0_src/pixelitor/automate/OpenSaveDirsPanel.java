...
class OpenSaveDirsPanel extends ValidatedForm {
    private final DirectoryChooser inputChooser = new DirectoryChooser(OpenSaveManager.getLastOpenDir().getAbsolutePath(), "Select Input Directory");
    private final DirectoryChooser outputChooser = new DirectoryChooser(OpenSaveManager.getLastSaveDir().getAbsolutePath(), "Select Output Directory");
