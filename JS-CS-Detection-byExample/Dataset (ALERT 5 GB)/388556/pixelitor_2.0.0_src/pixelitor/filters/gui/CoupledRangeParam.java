...
public class CoupledRangeParam extends AbstractGUIParam {
    ...
    public CoupledRangeParam(String name, int minValue, int maxValue, int defaultValue) {
        this(name, "Horizontal:", "Vertical:", minValue, maxValue, defaultValue, true);
    }
...
//        }
    ...
    public void considerImageSize(Rectangle bounds) {
        if(adjustMaxAccordingToImage) {
            ...
            rangeParam1.setMaximum(maxValue);
            rangeParam2.setMaximum(maxValue);
        }
    }

    public CoupledRangeParam adjustMaxAccordingToImage() {
