...
!define PRODUCT_VERSION "0.2.8.3.2.gcc"
...
Section "MainSection" SEC01
  ...
  CreateShortCut "$SMPROGRAMS\Armagetron Advanced\Armagetron Advanced Record.lnk" "$INSTDIR\armagetronad.exe" '--record "%USERPROFILE%\Desktop\ArmagetronAdvancedDebugRecording.aarec"'
  CreateShortCut "$SMPROGRAMS\Armagetron Advanced\Armagetron Advanced Playback.lnk" "$INSTDIR\armagetronad.exe" '--playback "%USERPROFILE%\Desktop\ArmagetronAdvancedDebugRecording.aarec"'
  CreateShortCut "$SMPROGRAMS\Armagetron Advanced\Armagetron Advanced Benchmark.lnk" "$INSTDIR\armagetronad.exe" '--benchmark --playback "%USERPROFILE%\Desktop\ArmagetronAdvancedDebugRecording.aarec"'
