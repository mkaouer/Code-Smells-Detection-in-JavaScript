...
# ADD CPP /nologo /W3 /GR /GX /Zi /O2 /I "src/win32_ded" /I "src" /I "../" /I "src/tools" /I "src/ui" /I "src/render" /I "src/engine" /I "src/network" /I "../winlibs/libxml2/include" /I "../winlibs/iconv/include" /I "src/thirdparty/particles" /D "_CONSOLE" /D "_MBCS" /D "NDEBUG" /FD /Zm200 /c
...
# ADD CPP /nologo /W3 /Gm /GR /GX /Zi /Od /I "src/win32_ded" /I "src" /I "../" /I "src/tools" /I "src/ui" /I "src/render" /I "src/engine" /I "src/network" /I "../winlibs/libxml2/include" /I "../winlibs/iconv/include" /I "src/thirdparty/particles" /D "_CONSOLE" /D "_MBCS" /D "DEBUG" /FR /FD /GZ /Zm200 /c
...
# ADD CPP /nologo /W3 /GR /GX /Zi /O2 /I "src/win32_ded" /I "src" /I "../" /I "src/tools" /I "src/ui" /I "src/render" /I "src/engine" /I "src/network" /I "../winlibs/libxml2/include" /I "../winlibs/iconv/include" /I "src/thirdparty/particles" /D "_CONSOLE" /D "DEBUG" /D "_MBCS" /FD /Zm200 /c
# ADD BASE RSC /l 0x407 /d "NDEBUG"
# ADD RSC /l 0x407 /d "NDEBUG"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
...
SOURCE=src\engine\eLagCompensation.cpp
# End Source File
# Begin Source File
...
SOURCE=src\engine\eLagCompensation.h
# End Source File
# Begin Source File
...
SOURCE=..\winlibs\libxml2\lib\libxml2.lib
# End Source File
# End Group
