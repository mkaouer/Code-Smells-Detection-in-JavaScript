...
# ADD CPP /nologo /MD /W3 /GR /GX /Zi /O2 /I "../winlibs/SDL_mixer" /I "../winlibs/SDL/include" /I "src/win32" /I "src" /I "../winlibs/SDL_image" /I "../" /I "src/tools" /I "src/ui" /I "src/render" /I "src/engine" /I "src/network" /I "../winlibs/libxml2/include" /I "../winlibs/iconv/include" /I "../winlibs/SDL_image/VisualC/graphics/include" /I "src/thirdparty/particles" /D "_WINDOWS" /D "DIRTY" /D "DONTUSEMEMMANAGER" /D "_MBCS" /D "NDEBUG" /FR /FD /Zm200 /c
...
# ADD CPP /nologo /MDd /W3 /GR /GX /Zi /Od /I "../winlibs/SDL_mixer" /I "../winlibs/SDL/include" /I "src/win32" /I "src" /I "../winlibs/SDL_image" /I "../" /I "src/tools" /I "src/ui" /I "src/render" /I "src/engine" /I "src/network" /I "../winlibs/libxml2/include" /I "../winlibs/iconv/include" /I "../winlibs/SDL_image/VisualC/graphics/include" /I "src/thirdparty/particles" /D "_WINDOWS" /D "_MBCS" /D "DEBUG" /Fr /FD /Zm200 /c
# ADD BASE MTL /nologo /D "NDEBUG" /mktyplib203 /win32
# ADD MTL /nologo /D "NDEBUG" /mktyplib203 /win32
# ADD BASE RSC /l 0x407 /d "NDEBUG"
# ADD RSC /l 0x407 /d "NDEBUG"
...
SOURCE=..\winlibs\SDL_image\VisualC\graphics\lib\libpng13.lib
# End Source File
# End Group
# Begin Group "Tron"
...
SOURCE=..\winlibs\SDL\src\main\win32\SDL_main.c
# End Source File
# End Target
# End Project
