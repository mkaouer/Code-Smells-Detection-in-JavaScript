...
{ 
  ...
  public ListSeqNo get(ListSeqNo value) throws FieldNotFound
  { 
    getField(value); 
    return value; 
  } 
  public ListSeqNo getListSeqNo() throws FieldNotFound
  { 
    ListSeqNo value = new ListSeqNo();  
    getField(value);  
    return value;  
  } 

  public void set(ListNoOrds value) 
  { 
    setField(value); 
  } 
  public ListNoOrds get(ListNoOrds value) throws FieldNotFound
  { 
    getField(value); 
    return value; 
  } 
  public ListNoOrds getListNoOrds() throws FieldNotFound
  { 
    ListNoOrds value = new ListNoOrds();  
    getField(value);  
    return value;  
  } 
