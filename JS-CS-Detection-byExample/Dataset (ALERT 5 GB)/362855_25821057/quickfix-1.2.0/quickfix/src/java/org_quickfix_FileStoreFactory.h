...
#include <jni.h>
/* Header for class org_quickfix_FileStoreFactory */

#ifndef _Included_org_quickfix_FileStoreFactory
#define _Included_org_quickfix_FileStoreFactory
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     org_quickfix_FileStoreFactory
 * Method:    create
 * Signature: ()V
 */
