...
{ 
  ...
  public void set(SecurityRequestType value) 
  { 
    setField(value); 
  } 
  public SecurityRequestType get(SecurityRequestType value) throws FieldNotFound
  { 
    getField(value); 
    return value; 
  } 
  ...
  { 
    SecurityRequestType value = new SecurityRequestType();  
    getField(value);  
    return value;  
  } 
