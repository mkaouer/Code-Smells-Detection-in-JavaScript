...
//                at.scale(((double)width) /charWidth, ((double)height) /charHeight);
                ...
                currentShape = typeModel.getSelectedItem().getShape(start, end);
            }
            ...
            if(gradientFillCB.isSelected()) {
                ...
                g.setPaint(new GradientPaint(start.x, start.y, fgColor, end.x, end.y, bgColor));
            } else {
                g.setColor(fgColor);
            }
