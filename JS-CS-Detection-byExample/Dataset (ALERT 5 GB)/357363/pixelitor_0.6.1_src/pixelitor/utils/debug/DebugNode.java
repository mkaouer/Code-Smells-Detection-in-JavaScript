...
public class DebugNode extends DefaultMutableTreeNode {
    ...
    protected void addStringChild(String name, String s) {
        add(new DefaultMutableTreeNode(name + " = " + s));
    }

    protected void addStringChildWithQuotes(String name, String s) {
        add(new DefaultMutableTreeNode(name + " = \"" + s + "\""));
    }

    protected void addIntChild(String name, int i) {
        add(new DefaultMutableTreeNode(name + " = " + i));
    }

    protected void addFloatChild(String name, float f) {
        add(new DefaultMutableTreeNode(name + " = " + f));
    }

    protected void addBooleanChild(String name, boolean b) {
        add(new DefaultMutableTreeNode(name + " = " + b));
    }

    protected void addClassChild() {
        add(new DefaultMutableTreeNode("class = " + userObject.getClass().getName()));
    }

    protected static void addIndent(StringBuilder sb, int indentLevel) {
        sb.append("\n");
