 ...
 *
 */
public class ActionParam implements GUIParam {
    private String name;
    ...
    public JComponent createControl() {
        OrderedExecutionButton b = new OrderedExecutionButton(name, actionListener, adjustingListener, iconImageName);
        return b;
    }
     ...
     */
    public static class OrderedExecutionButton extends JButton {

        public OrderedExecutionButton(String name, final ActionListener actionListener, final ParamAdjustingListener adjustingListener, String iconImageName) {
            super(name);
