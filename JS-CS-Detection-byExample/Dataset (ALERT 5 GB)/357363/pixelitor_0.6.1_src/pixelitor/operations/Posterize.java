...
import pixelitor.operations.lookup.FastLookupOp;
 ...
 * Posterize
 */
public class Posterize extends OperationWithParametrizedGUI {
    private RangeParam levels = new RangeParam("Levels", 2, 255, 2);

    public Posterize() {
        super("Posterize", true);
        paramSet = new ParamSet(levels);
    }
