...
public class LuminanceLookup {
    ...
    public static final float redContribution = 0.2126f;
    public static final float greenContribution = 0.7152f;
    public static final float blueContribution = 0.0722f;
