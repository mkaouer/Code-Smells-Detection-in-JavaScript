 ...
 */
public class JHSmear extends OperationWithParametrizedGUI {
    private RangeParam distance = new RangeParam("Distance", 0, 100, 0);
    private RangeParam density = new RangeParam("Density (%)", 0, 100, 50);
    private RangeParam angle = new RangeParam("Angle (only for lines)", 0, 360, 0);
    ...
    public BufferedImage transform(BufferedImage src, BufferedImage dest, ImageChangeReason changeReason) {
        ...
        filter.setShape(shape.getCurrentInt());
