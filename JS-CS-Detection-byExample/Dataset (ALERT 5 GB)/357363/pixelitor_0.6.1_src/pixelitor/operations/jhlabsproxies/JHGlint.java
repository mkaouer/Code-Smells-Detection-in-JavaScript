...
public class JHGlint extends OperationWithParametrizedGUI {
    ...
    private ColorParam color1 = new ColorParam("Inner Color", Color.WHITE);
    private ColorParam color2 = new ColorParam("Outer Color", Color.WHITE);
...
//        filter.setGlintOnly(glintOnly.isSelected());
