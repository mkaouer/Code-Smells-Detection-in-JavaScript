...
public class Layer {
     ...
     */
    public Layer(ImageComponent ic, int width, int height) {
        this.ic = ic;
        this.opacity = 1.0f;
        this.name = ic.generateNewLayerName();
    ...
    public void changeImage(BufferedImage img, ImageChangeReason changeReason) {
        if (changeReason == ImageChangeReason.OP_WITH_PREVIEW_FINISHED) {
            if(img != backupForPreviewBufferedImage) {
                History.setBackup(backupForPreviewBufferedImage, ic, changeReason);
            }
        } else if (changeReason.makeBackup()) {
            if(img != bufferedImage) {
                History.setBackup(bufferedImage, ic, changeReason);
            }
        }
...
//            System.out.println("Layer.drawLayerOnGraphics tmpDrawingComposite = " + tmpDrawingComposite.toString());
//            System.out.println("Layer.drawLayerOnGraphics getTranslationX() = " + getTranslationX());
//            System.out.println("Layer.drawLayerOnGraphics getTranslationY() = " + getTranslationY());
//            WritableRaster raster = tmpDrawingImage.getRaster();
//            int width = raster.getWidth();
//            int height = raster.getHeight();
//            System.out.println("Layer.drawLayerOnGraphics width = " + width + ", height = " + height);
            g.setComposite(tmpDrawingComposite);
