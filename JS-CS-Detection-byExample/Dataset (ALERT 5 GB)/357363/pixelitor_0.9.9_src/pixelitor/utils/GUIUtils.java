...
public final class GUIUtils {
    ...
    public static void showExceptionDialog(Exception e) {
        showExceptionDialog(PixelitorWindow.getInstance(), e);
    }

    public static void showOutOfMemoryDialog() {
        String message = "Out of the Java heap space. Try increasing the maximal memory available to Pixelitor with -Xmx";
        String title = "Out of memory error. Try increasing the memory available to Pixelitor with -Xmx";
...
//		frame.setLayout(new BorderLayout());
    ...
    /**
     * @return true if any window has focus
     */
