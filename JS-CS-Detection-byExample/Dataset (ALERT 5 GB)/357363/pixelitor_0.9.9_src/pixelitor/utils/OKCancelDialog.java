...
public abstract class OKCancelDialog extends JDialog {
    ...
    protected OKCancelDialog(JComponent formPanel, Frame owner, String title, boolean visible) {
        this(formPanel, owner, title, "OK", "Cancel", visible);
    }

    protected OKCancelDialog(JComponent formPanel, Frame owner, String title, String okText, String cancelText, boolean visible) {
