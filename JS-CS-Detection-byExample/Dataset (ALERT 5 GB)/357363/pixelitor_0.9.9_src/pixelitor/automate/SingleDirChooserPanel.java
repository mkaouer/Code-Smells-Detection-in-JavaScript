...
public class SingleDirChooserPanel extends ValidatedForm {
    ...
    public static boolean selectOutputDir(boolean addOutputChooser) {
        SingleDirChooserPanel chooserPanel = new SingleDirChooserPanel("Output Directory:", "Select Output Directory", OpenSaveManager.getLastSaveDir().getAbsolutePath(), addOutputChooser);
        ValidatedDialog chooser = new ValidatedDialog(chooserPanel, PixelitorWindow.getInstance(), "Select Output Folder", true);
        ...
        if (selectedDir != null) {
            OpenSaveManager.setLastSaveDir(selectedDir);
            return true;
        }
