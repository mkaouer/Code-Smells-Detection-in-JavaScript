...
public class ChannelMixer extends OperationWithParametrizedGUI {
    ...
    private ActionParam normalize = new ActionParam("Normalize", normalizeAction);

    private GUIParam[] params = new GUIParam[]{
            rpRedFromRed,
            rpRedFromGreen,
            rpRedFromBlue,
    ...
    private Action[] actions = new Action[]{switchRedGreen, switchRedBlue, switchGreenBlue, shiftRGBR, shiftRBGR, averageBW, luminosityBW};
    ...
    private void normalizeChannel(RangeParam fromRed, RangeParam fromGreen, RangeParam fromBlue) {
