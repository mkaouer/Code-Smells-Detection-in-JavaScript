...
public class JHCaustics extends OperationWithParametrizedGUI {
    private RangeParam scale = new RangeParam("Scale", 1, 500, 100);
    private RangeParam brightness = new RangeParam("Brightness", 0, 20, 7);
    private RangeParam focus = new RangeParam("Focus", 0, 100, 50);
    private RangeParam dispersion = new RangeParam("Dispersion", 0, 100, 0);
    ...
    private ColorParam bgColor = new ColorParam("Background Color:", new Color(0, 200, 175));

    private CausticsFilter filter;

    public JHCaustics() {
        super("Render Caustics", true);
