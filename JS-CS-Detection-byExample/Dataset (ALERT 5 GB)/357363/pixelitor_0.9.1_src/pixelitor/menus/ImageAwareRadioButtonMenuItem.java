 ...
 */
public class ImageAwareRadioButtonMenuItem extends JRadioButtonMenuItem implements ImageChangeListener {
    public ImageAwareRadioButtonMenuItem(String name) {
        super(name);
        init();
    }
