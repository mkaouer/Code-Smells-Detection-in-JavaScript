...
public class MenuBar extends JMenuBar {
    ...
    private void initEditMenu() {
        ...
        MenuFactory.createMenuItem(new CopyAction(CopyAction.Type.COPY_MERGED), KeyStroke.getKeyStroke('C', InputEvent.CTRL_MASK + InputEvent.SHIFT_MASK), editMenu, MenuEnableCondition.IF_THERE_IS_OPEN_IMAGE);
        // paste
        ...
        // resize
        MenuFactory.createMenuItem(new Resize(), KeyStroke.getKeyStroke('I', InputEvent.CTRL_MASK | InputEvent.ALT_MASK), editMenu, MenuEnableCondition.IF_THERE_IS_OPEN_IMAGE);
    ...
    private void initColorsMenu() {
        ...
        MenuFactory.createMenuItem(new HueSat(), null, colorsMenu);
    ...
    private void initFillSubMenu(JMenu colorsMenu) {
    ...
    private void initExtractChannelsSubMenu(JMenu colorsMenu) {
    ...
    private void initReduceColorsSubMenu(JMenu colorsMenu) {
    ...
    private void initFilterMenu() {
        ...
        MenuFactory.createMenuItem(new JHDropShadow(), null, filterMenu);

        MenuFactory.createMenuItem(CenteredText.INSTANCE, KeyStroke.getKeyStroke('T'), filterMenu);

        JMenu advancedFiltersSubMenu = new JMenu("Advanced");
...
//        debugSubMenu.add(transformMenuItem);
    ...
    public void setShowDevelopMenu(boolean newShowDevelopMenu) {
        System.out.println("MenuBar.setShowDevelopMenu newShowDevelopMenu = " + newShowDevelopMenu);
