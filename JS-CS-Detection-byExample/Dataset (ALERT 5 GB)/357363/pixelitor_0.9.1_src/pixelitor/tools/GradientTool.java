...
//        p.add(opacitySlider);
    ...
    public void mouseReleased(MouseEvent e, ImageComponent ic) {
        ...
        if (thereWasDragging) {
            saveImageForUndo(ic);
            drawGradient(ic.getActiveLayer(),
    ...
    public static void drawGradient(Layer layer, Type type, ColorType colorType, MultipleGradientPaint.CycleMethod cycleMethod, Composite composite, Point start, Point end, boolean invert) {
