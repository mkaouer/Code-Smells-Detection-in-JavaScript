...
public enum ShapeType {
    RECTANGLE {
        ...
        public Shape getShape(Point start, Point end) {
            updateCoordsPositive(start, end);
     ...
     */
    protected void updateCoordsPositive(Point start, Point end) {
     ...
     */
    protected void updateCoords(Point start, Point end) {
        x = start.x;
        y = start.y;
        width = end.x - start.x;
