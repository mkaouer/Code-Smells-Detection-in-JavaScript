...
public class UserDrag {
    ...
    /**
     * This constructor is for programmatically created UserDrag objects
     */
    ...
    public void setEndFromMouseEvent(MouseEvent e, ImageComponent ic) {
        double scale = ic.getViewScale();
        endX = (int) (e.getX() / scale);
        endY = (int) (e.getY() / scale);
...
//    public void adjustEndBoundaries(Composition comp) {
