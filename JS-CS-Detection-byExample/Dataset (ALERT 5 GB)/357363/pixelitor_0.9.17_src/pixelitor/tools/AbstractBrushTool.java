 ...
 *
 */
public abstract class AbstractBrushTool extends ForwardingTool implements ImageSwitchListener {
    ...
    public boolean mousePressed(MouseEvent e, ImageComponent ic) {
        ...
        if (e.isAltDown()) {
            COLOR_PICKER.sampleColor(e, ic, false);
            return true;
        }
    ...
    void finishBrushStroke(Composition comp) {
        AffectedArea affectedArea = new AffectedArea(comp, getRectangleAffectedByBrush(), false);
