...
public class SliderSpinner extends JPanel implements ChangeListener {
    ...
    private Resettable resettableParam; // if set to non-null, its reset is called instead of the reset of param
...
//        showTicksAsFloat();
    ...
    public void showTicksAsFloat() {
        ...
        Dictionary labelsDict = slider.getLabelTable();
        Enumeration keys = labelsDict.keys();
        while (keys.hasMoreElements()) {
            Integer i = (Integer) keys.nextElement();
            ((JLabel) labelsDict.get(i)).setText(String.valueOf(i / 100.0f));
        }
    }
