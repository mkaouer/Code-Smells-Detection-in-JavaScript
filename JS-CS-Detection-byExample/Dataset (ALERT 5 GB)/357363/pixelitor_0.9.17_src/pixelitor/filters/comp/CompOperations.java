 ...
 *
 */
public final class CompOperations {
    ...
    public static void cropImage(Composition comp, Selection selection) {
        ...
        for (int i = 0; i < nrLayers; i++) {
            ...
            layer.setBufferedImage(dest, true);
    ...
    public static void resize(Composition comp, int targetWidth, int targetHeight, boolean resizeInBox) {
        ...
        for (int i = 0; i < nrLayers; i++) {
            ...
            layer.setBufferedImage(resizedImg, true);
