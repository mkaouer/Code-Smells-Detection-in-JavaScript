 ...
 */
public class JHStamp extends OperationWithParametrizedGUI {
    ...
    private ColorParam darkColor = new ColorParam("Dark Color", Color.BLACK, true);
    private ColorParam brightColor = new ColorParam("Bright Color", Color.WHITE, true);
