...
public class HueSat extends OperationWithParametrizedGUI {
    ...
    private RangeParam hueParam = new RangeParam("Hue", MIN_HUE, MAX_HUE, DEFAULT_HUE);
    private RangeParam saturationParam = new RangeParam("Saturation", MIN_SAT, MAX_SAT, DEFAULT_SAT);
    private RangeParam brightnessParam = new RangeParam("Brightness", MIN_BRI, MAX_BRI, DEFAULT_BRI);
    ...
    public BufferedImage transform(BufferedImage src, BufferedImage dest) {
        ...
        float hueShift = hueParam.getValueAsPercentage() / 3.6f;
        float satShift = saturationParam.getValueAsPercentage();
        float briShift = brightnessParam.getValueAsPercentage();
