...
public final class SelectionActions {
    ...
    private static AbstractAction traceWithBrush = new TraceAction("Stroke with Current Brush", Tool.BRUSH);
    private static AbstractAction traceWithEraser = new TraceAction("Stroke with Current Eraser", Tool.ERASER);
