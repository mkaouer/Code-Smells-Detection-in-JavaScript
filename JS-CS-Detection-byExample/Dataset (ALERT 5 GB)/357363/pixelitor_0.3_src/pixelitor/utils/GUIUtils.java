...
public final class GUIUtils {
    private static final float MESSAGE_FONT_SIZE = 14.0f;
	...
	public static void showExceptionDialog(Component parent, Exception e) {
        ...
        String basicErrorMessage = "An exception occured: " + e.getMessage();
    ...
    public static void showLongMessageDialog(String message) {
        String title = "Information";
        Component parent = PixelitorWindow.getInstance();
        JTextArea ta = new JTextArea(message);
        ta.setEditable(false);
        Font font = ta.getFont();
        ta.setFont(font.deriveFont(Font.PLAIN, MESSAGE_FONT_SIZE));
