...
input_thread_t *input_CreateThread ( int i_method, void *p_source, int i_port,
                                     int i_vlan_id, p_vout_thread_t p_vout,
                                     p_aout_thread_t p_aout, int *pi_status )
{
    ...
    *p_input->pi_status         = THREAD_CREATE;
    ...
    intf_DbgMsg("configuration: method=%d, source=%s, port=%d, vlan_id=%d\n",
                i_method, p_source, i_port, i_vlan_id );
