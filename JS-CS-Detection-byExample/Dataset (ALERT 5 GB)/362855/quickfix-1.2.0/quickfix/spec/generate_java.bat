...
rem msxsl FIX42.xml generate_java_fields.xsl -o generate_java_fields.bat
rem call generate_java_fields.bat
rem msxsl FIX40.xml generate_java_messages.xsl -o generate_java_messages40.bat
rem msxsl FIX41.xml generate_java_messages.xsl -o generate_java_messages41.bat
rem msxsl FIX42.xml generate_java_messages.xsl -o generate_java_messages42.bat
rem call generate_java_messages40.bat
rem call generate_java_messages41.bat
rem call generate_java_messages42.bat