...
{ 
  ...
  public MaxMessageSize get(MaxMessageSize value) throws FieldNotFound
  { 
    getField(value); 
    return value; 
  } 
  ...
  { 
    MaxMessageSize value = new MaxMessageSize();  
    getField(value);  
    return value;  
  } 
  ...
  public NoMsgTypes get(NoMsgTypes value) throws FieldNotFound
  { 
    getField(value); 
    return value; 
  } 
  public NoMsgTypes getNoMsgTypes() throws FieldNotFound
  { 
    NoMsgTypes value = new NoMsgTypes();  
    getField(value);  
    return value;  
  } 
} 
