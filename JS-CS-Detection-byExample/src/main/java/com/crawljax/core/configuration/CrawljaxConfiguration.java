...
public final class CrawljaxConfiguration {
	 ...
	 */
	public void setFilterAttributeNames(List<Object> list) {
		String[] array = new String[list.size()];
		int index = 0;
		this.filterAttributeNames = new ArrayList<String>();
		for (Object value : list) {
		  array[index] = (String) value;
		  this.filterAttributeNames.add(array[index]);
		  index++;
		}// Fixed Object to String convertion problems
		//this.filterAttributeNames = new ArrayList<String>(array);
	}
